...
public class TypicalSuppliers {
    public static final Person ALICE = new SupplierBuilder().withName("Alice Pauline")
            .withAddress("123, Jurong West Ave 6, #08-111").withEmail("alice@example.com")
            .withPhone("94351253").withCategory("Customer")
            .withItem("Apples").build();
    public static final Person BENSON = new SupplierBuilder().withName("Benson Meier")
            .withAddress("311, Clementi Ave 2, #02-25").withEmail("johnd@example.com")
            .withPhone("98765432").withCategory("Customer")
            .withItem("Apples").build();
    public static final Person CARL = new SupplierBuilder().withName("Carl Kurz")
            .withPhone("95352563").withEmail("heinz@example.com")
            .withAddress("wall street").withCategory("Staff")
            .build();
    public static final Person DANIEL = new SupplierBuilder().withName("Daniel Meier").withPhone("87652533")
            .withEmail("cornelia@example.com").withAddress("10th street").withCategory("Customer").build();
    public static final Person ELLE = new SupplierBuilder().withName("Elle Meyer").withPhone("94822241")
    ...
    // Manually added
    public static final Person HOON = new SupplierBuilder().withName("Hoon Meier").withPhone("84824241")
            .withEmail("stefan@example.com").withAddress("little india").build();
    public static final Person IDA = new SupplierBuilder().withName("Ida Mueller").withPhone("84821311")
            .withEmail("hans@example.com").withAddress("chicago ave").build();

    // Manually added - Person's details found in {@code CommandTestUtil}
    public static final Person AMY = new SupplierBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            .withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY).withCategory(VALID_CATEGORY_STAFF).build();
    public static final Person BOB = new SupplierBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
