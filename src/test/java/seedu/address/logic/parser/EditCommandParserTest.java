...
import static seedu.address.logic.commands.CommandTestUtil.CATEGORY_DESC_CUSTOMER;
...
public class EditCommandParserTest {
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // categories
        userInput = targetIndex.getOneBased() + CATEGORY_DESC_STAFF;
        descriptor = new EditPersonDescriptorBuilder().withCategories(VALID_CATEGORY_STAFF).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    }
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY
                + CATEGORY_DESC_CUSTOMER + PHONE_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY + CATEGORY_DESC_CUSTOMER
